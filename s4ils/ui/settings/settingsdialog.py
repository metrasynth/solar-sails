...
from s4ils.ui.settings.audiosettingswidget import AudioSettingsWidget
from s4ils.ui.settings.sunvoxsettingswidget import SunVoxSettingsWidget
...
class SettingsDialog(SettingsDialogBase, Ui_SettingsDialog):
    ...
    def setupUi(self, ui):
        ...
        if sys.platform == 'darwin':
            self.setWindowTitle('S4ils Preferences')
        else:
            self.setWindowTitle('S4ils Settings')
